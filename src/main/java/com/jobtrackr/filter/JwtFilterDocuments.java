...
@WebFilter("/api/documents/*")
public class JwtFilterDocuments implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(JwtFilterDocuments.class);
    @Override
